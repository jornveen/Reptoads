...
var DisplayObject = function(ui, x, y, width, height, type) {
	this.ui = ui;
...
DisplayObject.prototype.onMousedown = function(callback) {
	this.ui.addEventListener('mousedown', callback, this);
};

DisplayObject.prototype.onMouseup = function(callback) {
	this.ui.addEventListener('mouseup', callback, this);
};
