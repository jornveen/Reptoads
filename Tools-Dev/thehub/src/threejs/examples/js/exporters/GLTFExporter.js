	...
	parse: function ( input, onDone, options ) {
		...
		function processMaterial( material ) {
			...
			if(material.type == "MeshPhongMaterial"){
				gltfMaterial.extras = {};
				gltfMaterial.extras["ambient_color"] =  [0.1,0.1,0.1];
				gltfMaterial.extras["specular_color"] =  material.specular.toArray();
				gltfMaterial.extras["diffuse_color"] = material.color.toArray();
				gltfMaterial.extras["emissiv_color"] = material.emissive.toArray();
				gltfMaterial.extras["specular_power"] = material.shininess;
			}			
