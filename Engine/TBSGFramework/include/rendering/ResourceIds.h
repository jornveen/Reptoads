...
namespace gfx
{
	// I need this otherwise my genericmultimap is broken, until there is a better unified architecture implemented I will be using this.
	struct Identifier
	{
		...
		uint32_t _id;
		/// Checks if this handle is not a null handle.
		/// \NOTE Does not mean that the handle is valid, in the case that the Texture was deleted for example
