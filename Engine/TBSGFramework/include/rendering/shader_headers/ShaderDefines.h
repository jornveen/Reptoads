...
#define SHADER_REGISTER(x)		 : register( x )
//#define SHADER_REGISTER(x, space)		 : register( x, space )
#define SHADER_CONSTANT_REGISTER(num)	: register(b##num)
//#define SHADER_CONSTANT_REGISTER(num, space)	: register(b##num, space)
#define SHADER_UAV_REGISTER(num)	: register(u##num)
//#define SHADER_UAV_REGISTER(num, space)	: register(u##num, space)
...
//This needs to be either AllMemoryBarrierWithGroupSync or GroupMemoryBarrierWithGroupSync
...
//Used to be SV_DispatchThreadID
...
#define SEM_POSITION
/// a ConstantBuffer register. Prefixed b on HLSL and c on PSSL
