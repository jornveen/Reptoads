...
namespace gfx
{
	...
	public:
		...
		//Texture&	GetTexture(TextureId textureId) override;
		//Texture& GetTexture(ptl::string texturePath) override;
		//Mesh&		GetMesh(MeshId meshId) override;
		//Material&	GetMaterial(MaterialId materialId) override;
		//IShader&	GetShader(ShaderId shaderId) override;

		//bool ContainsTexture(TextureId textureId) override;
		//bool ContainsTexture(ptl::string texturePath) override;
		//bool ContainsMesh(MeshId meshId) override;
		//bool ContainsMaterial(MaterialId materialId) override;
		//bool ContainsShader(ShaderId shaderId) override;
