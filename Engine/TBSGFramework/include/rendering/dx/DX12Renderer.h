...
namespace gfx
{
	...
	private:
		...
		//ptl::unordered_map < RenderPass*, ptl::vector<std::pair<ptl::string, gfx::Renderable*>>> m_Renderables;

		ptl::flat_value_map<gfx::PunctualRenderable, /*Handle=*/RenderableId> renderables;
		ptl::flat_value_map<ptl::unique_ptr<IRenderPass>, /*handle=*/RenderPassId> renderPasses;
