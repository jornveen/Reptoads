 ...
 * \brief
 *
 * Helper free function to assist with gameplay related tasks such as task to draw cards.
 * these functions aim to be as flexible as possible and should only do one specific task
*/
...
#ifndef PLATFORM_PS
		// Functions related to using or calling from the Lua environment
