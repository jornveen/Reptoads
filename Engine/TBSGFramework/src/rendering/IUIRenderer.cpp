...
namespace gfx
{
	...
	void IUIRenderer::AddImage(ui::UIImage* uiImage, glm::mat4 modelMatrix)
	{
		...
		// UPLOAD TO GPU BY PLATFORM SPECIFIC GPU RESOURCE MANAGER
	...
	ptl::array<gfx::Vertex, 4> IUIRenderer::CalculatePanelQuad(glm::vec2 size, float zDepth, glm::mat4 modelMatrix, glm::vec2 minUVs, glm::vec3 color, glm::vec3 normal) const
	{
		...
		// glm::mat4 orthographicMat = glm::ortho(0.0f, m_targetScreenSize.x, 0.0f, m_targetScreenSize.y);
	...
	{
		// This is a virtual call so other implementations can override it.
		// But all it needs to do is remove itself from the parent
	...
	//UIWidget* IUIRenderer::GetRootWidget()
	//{
	//	return root_.get();
	//}
	//void IUIRenderer::ClearAllUI()
	//{
	//	root_->children.clear();
	//}
	//ConstUIWidgetPerLayerIterator IUIRenderer::BeginLayerByLayer() const
	//{
	//	return ConstUIWidgetPerLayerIterator{ root_.get() };
	//}
	//UIWidgetPerLayerIterator IUIRenderer::EndLayerByLayer()
	//{
	//	return UIWidgetPerLayerIterator{ };
	//}
	//ConstUIWidgetPerLayerIterator IUIRenderer::EndLayerByLayer() const
	//{
	//	return ConstUIWidgetPerLayerIterator{ };
	//}
