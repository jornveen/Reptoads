...
namespace gfx
{
	...
	void CreatePlane( float width, float height, ptl::vector<uint32_t>& indices, ptl::vector<Vertex>& vertices, bool rhcoords)
	{
		vertices =
		{
			{ glm::vec3(-0.5f * width, 0.0f,  0.5f * height), colorWhite3, glm::vec3(0.0f, 1.0f, 0.0f), glm::vec2(1.0f, 0.0f) }, // 0
			{ glm::vec3(0.5f * width, 0.0f,  0.5f * height),  colorWhite3, glm::vec3(0.0f, 1.0f, 0.0f), glm::vec2(0.0f, 0.0f) }, // 1
			{ glm::vec3(0.5f * width, 0.0f, -0.5f * height),  colorWhite3, glm::vec3(0.0f, 1.0f, 0.0f), glm::vec2(0.0f, 1.0f) }, // 2
			{ glm::vec3(-0.5f * width, 0.0f, -0.5f * height), colorWhite3, glm::vec3(0.0f, 1.0f, 0.0f), glm::vec2(1.0f, 1.0f) }  // 3
		};
