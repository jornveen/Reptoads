    ...
    , m_TearingSupported(false)
{
	...
	wndClass.hIconSm = NULL; //LoadIcon( m_hInstance, MAKEINTRESOURCE( APP_ICON ) );
...
/*int DX12Application::Run(std::shared_ptr<Game> pGame)
{
...
extern LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    if ( pWindow )
    {
        ...
        case WM_KEYDOWN:
        {
            ...
            //unsigned int scanCode = (lParam & 0x00FF0000) >> 16; unused
