...
PanoToCubemapPSO::PanoToCubemapPSO()
{
    ...
    m_DefaultUAV = DX12Application::Get().AllocateDescriptors(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 5);
    //UINT descriptorHandleIncrementSize = DX12Application::Get().GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
