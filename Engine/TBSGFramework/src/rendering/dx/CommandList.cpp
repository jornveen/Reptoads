...
{
	TransitionBarrier(dstRes, D3D12_RESOURCE_STATE_RESOLVE_DEST, D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES/*dstSubresource*/);
	TransitionBarrier(srcRes, D3D12_RESOURCE_STATE_RESOLVE_SOURCE, D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES/*srcSubresource*/);
...
void CommandList::GenerateMips_UAV(Texture& texture, bool isSRGB)
{
	...
	for (uint32_t srcMip = 0; srcMip < resourceDesc.MipLevels - 1u; ) {
		...
		SetShaderResourceView(GenerateMips::SrcMip, 0, texture, /*D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE*/D3D12_RESOURCE_STATE_UNORDERED_ACCESS, srcMip, D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES, &srvDesc);
