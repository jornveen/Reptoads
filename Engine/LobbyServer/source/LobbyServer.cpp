...
void LobbyServer::Run()
{
	...
	{
		this->ReceivePackets(); // TODO: Run in separate thread.
		this->HandlePackets(); // Keep in main thread.
...
void LobbyServer::HandleCustomPacket(unsigned customCommand, Packet& packet, net::Connection* connection)
{
	...
	case tbsg::ClientLobbyCommands::ListLobbies:
	{
		...
		for(const auto& lobby : GetLobbies())
		{
			...
			bool started = false; // lobby.IsInGame()
	...
	{
		// TODO: Implement ClientLobbyCommands::LobbyGameStop behaviour.
	}
	break;
