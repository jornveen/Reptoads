...
public:
	...
	/**
	 * \brief Function to send a custom packet without any content.
	 */
	inline void SendCustomPacket(tbsg::ServerLobbyCommands command, net::Connection* connection);
	/**
	 * \brief Function to send a custom packet with content.
	 */
...
private:
	...
	/**
	 * \brief Function to handle player leaving a lobby.
	 * \param connection The connection that will leave the lobby.
	 */
